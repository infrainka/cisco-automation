...
Ansible IaC for Cisco IOS-XE IKEv2/IPsec remote-access VPN deployment — full mutual PKI
(certificate authentication), licensing bootstrap, and supporting crypto infrastructure.
...
`hosts.ini` in this directory contains only placeholders. Copy and fill in your device details before running any playbook. Store real credentials in Ansible Vault — never commit plaintext passwords.
